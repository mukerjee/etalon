...
CONFIGS = [{'type': 'strobe', 'buffer_size': 4},
           ...
           {'type': 'resize', 'days_out': 1},
           {'type': 'resize', 'days_out': 2},
           {'type': 'resize', 'days_out': 3},
           {'type': 'resize', 'days_out': 4},
           {'type': 'resize', 'days_out': 5},
           {'type': 'strobe', 'cc': 'ocs'},
           {'type': 'resize', 'days_out': 1, 'cc': 'ocs'},
           {'type': 'resize', 'days_out': 2, 'cc': 'ocs'},
           {'type': 'resize', 'days_out': 3, 'cc': 'ocs'},
           {'type': 'resize', 'days_out': 4, 'cc': 'ocs'},
           {'type': 'resize', 'days_out': 5, 'cc': 'ocs'},
]
