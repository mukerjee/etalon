...
//
  ...
  //pointToPoint.SetDeviceAttribute ("Mtu", UintegerValue(1024*1024));
...
//
  ...
  source.SetAttribute ("Remote", AddressValue(InetSocketAddress(i.GetAddress(0), port)));
  sourceApps.Add(source.Install (nodes.Get (1)));
