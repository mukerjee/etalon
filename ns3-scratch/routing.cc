...
main (int argc, char *argv[])
{
  ...
  // PointerValue tmp;
  // d3d2.Get(0)->GetAttribute ("TxQueue", tmp);
  // Ptr<Object> txQueue = tmp.GetObject();
  // txQueue->SetAttribute("MaxPackets", UintegerValue(1));
  Config::Set("/NodeList/2/DeviceList/2/TxQueue/MaxPackets", UintegerValue(1));
