...
xmin = 144
xmax = 4644
plot(c(), xlim=c(0, ts_max), ylim=c(0, 7.2), 
...
plot(x = my_data[1:m_size[1], 1], y= my_data[1: m_size[1], 2], ylim=c(0, 10.1), 
    col='black', type = 'l', xlab = 'Time (s)' , ylab='Throughput (%)', 
    cex.lab=1, cex.axis=1, bty='n', yaxt='n');
axis(2, at=c(0,2,4,6,8,10), labels=c(0,20,40,60,80,100), cex.axis=0.9);
